...
V2 (net2 0) vsource dc=p6     type=dc mag=1
V1 (net1 0) vsource dc=p6-p4  type=dc
V4 (net4 0) vsource dc=p6     type=dc
V3 (net3 0) vsource dc=p6-p4  type=dc mag=1
...
ac ac freq=p5 param=p6 start=p1 stop=p2 lin=p3 annotate=status
dc dc param=p6 start=p1 stop=p2 lin=p3 annotate=status
